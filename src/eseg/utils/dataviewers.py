    ...
    def __init__(self, camera, video_save_path: Optional[str] = None
        ...
        if self.video_save_path is not None:
            ...
            if self.video_save_path.endswith('.mp4'):
                ...
                self.video_writer = imageio.get_writer(self.video_save_path, fps=20, mode='I', loop=0)
                self.save_type = 'gif'
        self.camera = camera
        ...
        if self.video_save_path is not None:
            if self.save_type == 'gif':
                ...
                if self.video_writer is None:
                    ...
                    self.video_writer = cv2.VideoWriter(self.video_save_path, self.fourcc, 20.0, (width, height))
